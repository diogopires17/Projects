...
// Function to adjust the icon position when showing the strength bar
function adjustIconPosition() {
    var passwordText = document.getElementById('password-text');
    var showPassIcon1 = document.getElementById('showPassIcon1');
    if (passwordText.innerHTML.length > 0) {
      showPassIcon1.style.top = '60%';
    } else {
      showPassIcon1.style.top = '72%';
    }
}